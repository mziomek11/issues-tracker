...
public class AuthInvalidCredentialsRestErrorResponse {
    private static final ApplicationErrorCode CODE = ApplicationErrorCode.AUTH_INVALID_CREDENTIALS;
    ...
    private AuthInvalidCredentialsRestErrorResponse() {}
}
