...
public class OrganizationMemberAlreadyPresentRestErrorResponse {
    private static final ApplicationErrorCode CODE = ApplicationErrorCode.ORGANIZATION_MEMBER_ALREADY_PRESENT;
    private static final HttpStatus STATUS = HttpStatus.CONFLICT;
    private static final String MESSAGE = "Member with id %s is already in organization";
    ...
    private OrganizationMemberAlreadyPresentRestErrorResponse() {}
}
